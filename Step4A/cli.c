    ...
    switch(choix)
    {
      case 1:
         ...
         UneRequete.Numero = ++NumRequete;
          ...
          {
            printf("bytes lus:%d\nConstructeur, modele, quantite, puissance :%s %s %d %d\n",rc,UneRequete.Constructeur,UneRequete.Modele,UneRequete.Quantite,UneRequete.Puissance ) ;
